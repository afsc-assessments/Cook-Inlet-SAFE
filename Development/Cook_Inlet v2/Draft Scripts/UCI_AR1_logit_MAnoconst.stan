...
transformed parameters{
  ...
  err[1] = logit_F_state_hist[1]*theta;
  // err[1] = 0;
  ...
  logit_curr_predFstate =  logit_F_state_hist[n_years] + theta*err[n_years];
...
generated quantities{
  ...
  logit_post_curr_predFstate =  logit_F_state_hist[n_years] + theta*normal_rng(0,sigma_F);
